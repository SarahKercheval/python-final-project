...
def recipe_specifics(self, root):
    ...
    self.recipe_name = self.recipe_name.get()
    self.description = self.description.get('1.0', END)
    ...
    self.vegetarian = self.vegetarian_var.get()
    ...
    if self.vegetarian == True:
        self.categories.append('Vegetarian')
    ...
    recipe_editor(self.times, self.categories, self.recipe_name, self.description)

        
class recipe_editor():
    def __init__(self, times, categories, name, description):
        self.name = name
        ...
        self.recipe_editor_window(times, categories, name, description)

    def recipe_editor_window(self, times, categories, name, description):
        #print(self.times, self.categories)
        #make window to edit recipe
        editor_window = tk.Tk()
        editor_window.title('Recipe Editor')
        editor_window.rowconfigure(1, minsize = 800, weight = 1)
        editor_window.columnconfigure(1, minsize = 800, weight = 1)
        ...
        display_name = tk.Label(editor_window, text = name, font = ('Times New Roman', '20'))
        display_name.grid(row = 1, column = 1, columnspan = 5)

        display_description = tk.Label(editor_window, text = description, font = ('Times New Roman', '14'))
        display_description.grid(row = 5, column = 1, rowspan = 5)


        tags = tk.Label(editor_window, text = categories, font = ('Times New Roman', '12'))
        tags.grid(row = 2, column = 0, columnspan = 5)

        times = tk.Label(editor_window, text = times, font = ('Times New Roman', '12'))
        times.grid(row = 3, column = 0, columnspan = 5)
        ...
        def quit_editor(self, parent):
            ...
            def quit_application(self, parent):
                #method to quit the entire application
                parent.destroy()
                new_root.destroy()
